...
function Sidebar() {
  return (
    <div>
      <Disclosure as="nav">
        <DisclosureButton className="absolute top-4 right-4 inline-flex items-center peer justify-center rounded-md p-2 text-teal-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:rind-white group hover:bg-gray-400">
          <GiHamburgerMenu
          ...
          <div className="flex flex-col justify-start items-center">
            ...
            <div className="my-4 pb-4">
              <div className="flex mb-2 justify-start p-2 border-b border-white">
                <h3 className="text-base text-white font-semibold">General</h3>
              </div>
              {/* DASHBOARD */}
