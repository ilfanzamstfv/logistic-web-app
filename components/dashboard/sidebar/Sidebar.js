...
function Sidebar() {
  return (
    <div>
      <Disclosure as="nav">
        <DisclosureButton className="absolute top-4 right-4 inline-flex items-center peer justify-center rounded-md p-2 text-white hover:text-teal-500 focus:outline-none focus:ring-2 focus:ring-inset focus:rind-white group hover:bg-white">
          <GiHamburgerMenu
